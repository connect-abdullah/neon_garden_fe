...
export default function ServiceDetail() {
  ...
  const isIncludesLayout = service.packageIncludes?.length > 0
        ...
        <Container>
          ...
          {service.pageCta && (
            <div className="mt-6 flex justify-center md:mt-8">
              <CTA
                embedded
                description={service.pageCta.description}
                itemsTitle={isIncludesLayout ? 'Our packages include' : undefined}
                items={service.packageIncludes}
                buttonText={service.pageCta.buttonText}
                buttonTo={service.pageCta.buttonTo}
                rounded
              />
            </div>
          )}
          ...
          {!isIncludesLayout && !service.packages?.length && service.showcase?.length > 0 && (
            <div className="mt-4">
              <GalleryMasonry
