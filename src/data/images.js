...
export const siteImages = {
  ...
  brandStoryCollage: [
    { src: engagement('18057494854532834.jpg'), alt: 'Engagement table and floral styling', aspect: 'tall' },
    { src: birthday('18045780019824849.jpg'), alt: 'Birthday pastel décor setup', aspect: 'wide' },
    { src: engagement('18023288527219482.jpg'), alt: 'Cultural event lounge styling', aspect: 'square' },
    { src: engagement('17991403118499247.jpg'), alt: 'Wedding reception floral styling', aspect: 'tall' },
    { src: proposals('17948329442674517.jpg'), alt: 'Proposal floral arch detail', aspect: 'wide' },
  ],
